...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var date_fns_formatRelative__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns/formatRelative */ "./node_modules/date-fns/esm/formatRelative/index.js");
...
function makeTodoForm(condition, element) {
  ...
  dueDate.id = "dueDate";
  dueDate.value = `${(0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__.default)(new Date(), "yyyy-MM-dd'T'hh:mm", {
...
function displayTodo(toDo) {
  ...
  dueDate.innerText = `Due: ${(0,date_fns_formatRelative__WEBPACK_IMPORTED_MODULE_1__.default)(
    (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_2__.default)(toDo.dueDate),
    new Date()
  )}`;
...
function displayCompletedTask(task) {
  ...
  const dueDate = make("div");
  dueDate.innerText = `Due Date: ${(0,date_fns_formatRelative__WEBPACK_IMPORTED_MODULE_1__.default)(
    (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_2__.default)(task.dueDate),
    new Date()
  )}`;
  dueDate.classList.add("dueDate");

  const completedTime = make("div");
  completedTime.innerText = `Completed: ${(0,date_fns_formatRelative__WEBPACK_IMPORTED_MODULE_1__.default)(
    (0,date_fns_parseISO__WEBPACK_IMPORTED_MODULE_2__.default)(task.completedTime),
    new Date()
  )}`;
...
function taskCompleted(e) {
  ...
  todo.isDone = true;
  todo.completedTime = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__.default)(new Date(), "yyyy-MM-dd'T'HH:mm:ss.SSSxxx");
  completed.push(todo);
  todoItem.remove();
  deleteTodo(todoItem.id);
}
